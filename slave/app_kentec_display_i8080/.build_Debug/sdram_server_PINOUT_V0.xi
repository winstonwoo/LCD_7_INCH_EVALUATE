# 1 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
# 1 "platform.h" 1 3
# 21 "platform.h" 3
...
# 22 "platform.h" 2 3
# 2 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
# 3 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
# 1 "sdram_geometry_PINOUT_V0.h" 1
# 5 "sdram_geometry_PINOUT_V0.h"
# 1 "sdram_conf.h" 1
# 6 "sdram_geometry_PINOUT_V0.h" 2
# 4 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
# 1 "sdram_config_PINOUT_V0.h" 1
# 5 "sdram_config_PINOUT_V0.h"
# 1 "sdram_conf.h" 1
# 6 "sdram_config_PINOUT_V0.h" 2
# 5 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
...
# 6 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
# 7 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
# 1 "sdram_control.h" 1
# 8 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
# 1 "sdram_conf_derived.h" 1
# 6 "sdram_conf_derived.h"
# 1 "sdram_conf.h" 1
# 7 "sdram_conf_derived.h" 2
# 9 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
...
void sdram_init_PINOUT_V0(struct sdram_ports_PINOUT_V0 &p) {
  ...
  __builtin_partout_timed(p.cas, 1, 0x1 , t+32) ;
  __builtin_partout_timed(p.ras, 1, 0x1 , t+32) ;
  __builtin_partout_timed(p.we, 1, 0x1 , t+32) ;
  ...
  __builtin_set_port_clk(p.dqm, p.cb) ;
  ...
  T when  __builtin_timer_after(t + 50 * 100 )  :> t;

  p.cke <: 1;

  T when  __builtin_timer_after(t + 100 * 100 )  :> t;
...
# 97 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
static inline void sdram_refresh_PINOUT_V0(unsigned ncycles, struct sdram_ports_PINOUT_V0 &p) {
  ...
  for (unsigned i = 0; i < ncycles; i+=8){
	t+=32;
	__builtin_partout_timed(p.cas, 32, ( ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) | ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) <<8)) | ( ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) | ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) <<8)) <<16)) , t) ;
	__builtin_partout_timed(p.ras, 32, ( ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) | ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) <<8)) | ( ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) | ( ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) | ( ( 0x0 | ( 0x1 <<1)| ( 0x1 <<2)| ( 0x1 <<3)) <<4)) <<8)) <<16)) , t) ;
  }
}
...
void sdram_short_block_read_PINOUT_V0(unsigned buffer, unsigned word_count, out port dq,
    out buffered port:8 ctrl, unsigned term_time, unsigned st, out buffered port:32 ras);
# 122 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
static unsigned bank_table[ (1<< 2 ) ] =
   {(0<<13) | (0<<(13+16) | 1<<(10+16)),
    (1<<13) | (1<<(13+16) | 1<<(10+16)),
    (2<<13) | (2<<(13+16) | 1<<(10+16)),
    (3<<13) | (3<<(13+16) | 1<<(10+16))};
# 128 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
...
static inline void sdram_write_PINOUT_V0(unsigned row, unsigned col, unsigned bank,
    unsigned buffer, unsigned word_count, struct sdram_ports_PINOUT_V0 &ports) {
	  ...
	  unsigned jump;
	  unsigned rowcol;
# 145 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
	  ...
	  t =  __builtin_partout_timestamped(ports.dqm, 1, 0) ;
...
# 167 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
#pragma unsafe arrays
...
# 194 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
#pragma unsafe arrays
static inline void sdram_read_PINOUT_V0(unsigned row, unsigned col, unsigned bank,
  ...
  unsigned jump;
  unsigned rowcol;
# 211 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
...
# 246 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc"
...
static void read_buffer(unsigned start_row, unsigned start_col,
  ...
  while (1) {
    ...
    if (words_to_end_of_line < remaining_words) {
      sdram_read_PINOUT_V0 (current_row, current_col, bank, buffer, words_to_end_of_line, ports);
      current_col = 0;
      current_row++;
      buffer += 4 * words_to_end_of_line;
      remaining_words -= words_to_end_of_line;
    } else {
      sdram_read_PINOUT_V0 (current_row, current_col, bank, buffer, remaining_words, ports);
      return;
    }
    if(current_row ==  (1<< 11 ) ){
      current_row = 0;
...
static void write_buffer(unsigned start_row, unsigned start_col,
  ...
  while (1) {
    words_to_end_of_line = ( (1<< 8 )  - current_col) / 2;
    if (words_to_end_of_line < remaining_words) {
      sdram_write_PINOUT_V0 (current_row, current_col, bank, buffer, words_to_end_of_line, ports);
      current_col = 0;
      current_row++;
      buffer += 4 * words_to_end_of_line;
      remaining_words -= words_to_end_of_line;
    } else {
      sdram_write_PINOUT_V0 (current_row, current_col, bank, buffer, remaining_words, ports);
      return;
    }
    if(current_row ==  (1<< 11 ) ){
      current_row = 0;
...
static void handle_command(char cmd, chanend client, struct  sdram_ports_PINOUT_V0  &ports) {
  switch (cmd) {
    ...
    case SDRAM_CMD_FULL_ROW_WRITE: {
      ...
      sdram_write_PINOUT_V0 (start_row, 0, bank, pointer,  ( (1<< 8 ) * (16) /32) , ports);
      break;
    }
    ...
    case SDRAM_CMD_FULL_ROW_READ: {
      ...
      sdram_read_PINOUT_V0 (start_row, 0, bank, pointer,  ( (1<< 8 ) * (16) /32) , ports);
      break;
    }
    ...
    case SDRAM_CMD_COL_WRITE: {
      ...
      sdram_col_write_PINOUT_V0 (bank, row, col, data, ports);
      break;
    }
...
void  sdram_server_PINOUT_V0 (chanend client, struct  sdram_ports_PINOUT_V0  &ports) {
  ...
  unsigned T, now, then;
  sdram_init_PINOUT_V0 (ports);
  {
    timer t;
    sdram_refresh_PINOUT_V0 ( 2048 , ports);
    t:> then;
    T = then +  (( 100000 * 32 )/ 2048 )  *  ( 2048 /8) ;
    while (1) {
...
#pragma ordered
      select {
        case t when  __builtin_timer_after(T)  :> now: {
          ...
          unsigned num_refreshes = (elapsed_ref_ticks/ (( 100000 * 32 )/ 2048 ) ) + 1;
          sdram_refresh_PINOUT_V0 (num_refreshes, ports);
          then = now;
          T = then +  (( 100000 * 32 )/ 2048 )  *  ( 2048 /8) ;
          break;
        }
...
# 247 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V0/sdram_server_PINOUT_V0.xc" 2
