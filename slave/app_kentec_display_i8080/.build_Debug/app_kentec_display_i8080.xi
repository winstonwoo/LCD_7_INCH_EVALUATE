# 1 "../src/app_kentec_display_i8080.xc"
# 1 "platform.h" 1 3
# 21 "platform.h" 3
...
# 22 "platform.h" 2 3
# 2 "../src/app_kentec_display_i8080.xc" 2
# 1 "xs1.h" 1 3
# 3 "../src/app_kentec_display_i8080.xc" 2
# 1 "lcd.h" 1
# 3 "lcd.h"
# 1 "xs1.h" 1 3
# 4 "lcd.h" 2
...
# 4 "../src/app_kentec_display_i8080.xc" 2
# 1 "sdram.h" 1
# 4 "sdram.h"
# 1 "stdint.h" 1 3
# 17 "stdint.h" 3
...
# 5 "../src/app_kentec_display_i8080.xc" 2
...
# 6 "../src/app_kentec_display_i8080.xc" 2
# 1 "transitions.h" 1
# 17 "transitions.h"
...
unsigned transition_alpha_blend(chanend server, unsigned frame_buffer[2],
    unsigned image_from, unsigned image_to, unsigned frames,
    unsigned cur_fb_index);
# 7 "../src/app_kentec_display_i8080.xc" 2
# 1 "i8080_slave.h" 1
...
# 8 "../src/app_kentec_display_i8080.xc" 2
# 1 "stdio.h" 1 3
# 4 "stdio.h" 3
# 1 "stdio.h" 1 3
# 29 "stdio.h" 3
...
# 6 "stdio.h" 2 3
# 9 "../src/app_kentec_display_i8080.xc" 2
# 1 "stdlib.h" 1 3
# 4 "stdlib.h" 3
# 1 "stdlib.h" 1 3
# 10 "stdlib.h" 3
...
# 6 "stdlib.h" 2 3
# 10 "../src/app_kentec_display_i8080.xc" 2

out port bo =  0x10500 ;
lcd_ports lcdports = {  0x10600 ,  0x10400 ,  0x200000 ,  0x106  };
sdram_ports_PINOUT_V2_IS42S16400F  sdramports = { 0x100000 ,  0x40500 ,  0x10700 ,  0x206  };
i8080_handler i8080ports = { 0x80300 ,  0x40400 ,  0x10b00 };

unsigned c = 0xffffffff;
unsigned super_pattern() {
  __builtin_crc32(c, 0xff, 0x82F63B78) ;
  return c;
}
...
void application(chanend c_dc, streaming chanend c_i8080){
  ...
  frame_buffer[0] = register_image(c_dc,  ( (800) * (16) /32) ,  (480) );
  frame_buffer[1] = register_image(c_dc,  ( (800) * (16) /32) ,  (480) );
  frame_buffer_init(c_dc, image[0]);

  while(1){
    unsigned next_image = (current_image+1)% (2) ;
    ...
    fb_index = transition_wipe(c_dc, frame_buffer, image[current_image], image[next_image],  ( (800) * (16) /32) , fb_index);
    current_image = next_image;
    next_image = (current_image+1)% (2) ;
...
int main(){
  ...
  par {
    ...
    sdram_server_PINOUT_V2_IS42S16400F (c_sdram, sdramports);
