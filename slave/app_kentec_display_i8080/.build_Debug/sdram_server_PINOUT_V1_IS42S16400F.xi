# 1 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
# 1 "platform.h" 1 3
# 21 "platform.h" 3
...
# 22 "platform.h" 2 3
# 2 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
# 3 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
...
# 4 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
# 1 "sdram_config_PINOUT_V1_IS42S16400F.h" 1
# 5 "sdram_config_PINOUT_V1_IS42S16400F.h"
# 1 "sdram_conf.h" 1
# 6 "sdram_config_PINOUT_V1_IS42S16400F.h" 2
# 5 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
...
# 6 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
# 7 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
# 1 "sdram_control.h" 1
# 8 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
# 1 "sdram_conf_derived.h" 1
# 6 "sdram_conf_derived.h"
# 1 "sdram_conf.h" 1
# 7 "sdram_conf_derived.h" 2
# 9 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
...
# 106 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
static inline void sdram_refresh_PINOUT_V1_IS42S16400F(unsigned ncycles, struct sdram_ports_PINOUT_V1_IS42S16400F &p) {
  ...
  t+=8;
  __builtin_partout_timed(p.cas, 8* 2 , ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) | ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) <<( 2 *4))) , t) ;
  __builtin_partout_timed(p.ras, 8* 2 , ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) | ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) <<( 2 *4))) , t) ;
  for (unsigned i = 8; i < ncycles; i+=8){
    __builtin_partout(p.cas, 8* 2 , ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) | ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) <<( 2 *4))) ) ;
    __builtin_partout(p.ras, 8* 2 , ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) | ( ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) | ( ( ( 0x0 | ( 0x1 <<1)) | ( ( 0x0 | ( 0x1 <<1)) << 2 )) <<( 2 *2))) <<( 2 *4))) ) ;
  }
}
...
void sdram_short_block_read_PINOUT_V1_IS42S16400F(unsigned buffer, unsigned word_count, buffered port:32 dq,
    out buffered port:8 ctrl, unsigned term_time, unsigned st, out buffered port:32 ras);
# 138 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
static unsigned bank_table[ (1<< 2 ) ] =
   {(0<<13) | (0<<(13+16) | 1<<(10+16)),
    (1<<13) | (1<<(13+16) | 1<<(10+16)),
    (2<<13) | (2<<(13+16) | 1<<(10+16)),
    (3<<13) | (3<<(13+16) | 1<<(10+16))};
# 144 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
...
# 178 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
#pragma unsafe arrays
...
# 204 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
#pragma unsafe arrays
...
# 245 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc"
...
static void read_buffer(unsigned start_row, unsigned start_col,
    ...
    struct  sdram_ports_PINOUT_V1_IS42S16400F  &ports) {
  ...
  while (1) {
    ...
    if (words_to_end_of_line < remaining_words) {
      sdram_read_PINOUT_V1_IS42S16400F (current_row, current_col, bank, buffer, words_to_end_of_line, ports);
      current_col = 0;
      current_row++;
      buffer += 4 * words_to_end_of_line;
      remaining_words -= words_to_end_of_line;
    } else {
      sdram_read_PINOUT_V1_IS42S16400F (current_row, current_col, bank, buffer, remaining_words, ports);
      return;
    }
    if(current_row ==  (1<< 12 ) ){
      current_row = 0;
...
static void write_buffer(unsigned start_row, unsigned start_col,
  ...
  while (1) {
    words_to_end_of_line = ( (1<< 8 )  - current_col) / 2;
    if (words_to_end_of_line < remaining_words) {
      sdram_write_PINOUT_V1_IS42S16400F (current_row, current_col, bank, buffer, words_to_end_of_line, ports);
      current_col = 0;
      current_row++;
      buffer += 4 * words_to_end_of_line;
      remaining_words -= words_to_end_of_line;
    } else {
      sdram_write_PINOUT_V1_IS42S16400F (current_row, current_col, bank, buffer, remaining_words, ports);
      return;
    }
    if(current_row ==  (1<< 12 ) ){
      current_row = 0;
...
static void handle_command(char cmd, chanend client, struct  sdram_ports_PINOUT_V1_IS42S16400F  &ports) {
  switch (cmd) {
    ...
    case SDRAM_CMD_FULL_ROW_WRITE: {
      ...
      sdram_write_PINOUT_V1_IS42S16400F (start_row, 0, bank, pointer,  ( (1<< 8 ) * (16) /32) , ports);
      break;
    }
    ...
    case SDRAM_CMD_FULL_ROW_READ: {
      ...
      sdram_read_PINOUT_V1_IS42S16400F (start_row, 0, bank, pointer,  ( (1<< 8 ) * (16) /32) , ports);
      break;
    }
    ...
    case SDRAM_CMD_COL_WRITE: {
      ...
      sdram_col_write_PINOUT_V1_IS42S16400F (bank, row, col, data, ports);
      break;
    }
...
void  sdram_server_PINOUT_V1_IS42S16400F (chanend client, struct  sdram_ports_PINOUT_V1_IS42S16400F  &ports) {
  ...
  unsigned T, now, then;
  sdram_init_PINOUT_V1_IS42S16400F (ports);
  {
    timer t;
    sdram_refresh_PINOUT_V1_IS42S16400F ( 4096 , ports);
    t:> then;
...
#pragma ordered
      select {
        case t when  __builtin_timer_after(T)  :> now: {
          ...
          sdram_refresh_PINOUT_V1_IS42S16400F (num_refreshes, ports);
          then = now;
          T = then +  (( 100000 * 64 )/ 4096 )  *  8 ;
          break;
        }
...
# 246 "J:/ProjectEstimated2014/XMOS/HMI/REF_8080_RGB/HMI/slave/module_sdram/src/PINOUT_V1_IS42S16400F/sdram_server_PINOUT_V1_IS42S16400F.xc" 2
